...
exports.createNewMeeting = exports.signForMeeting = exports.updateSettings = void 0;
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            res = _context.sent;
            if (res.data.status === 'success') alert("".concat(type.toUpperCase(), " updated successfully!"));
            _context.next = 11;
            break;
...
var signForMeeting = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "http://127.0.0.1:3000/api/v1/meetings/".concat(id)
            });
  ...
  return function signForMeeting(_x3) {
    return _ref2.apply(this, arguments);
  };
}();

exports.signForMeeting = signForMeeting;

var createNewMeeting = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              alert('Meeting created successfully!'); // window.setTimeout(() => {
              //   location.assign('/');
              // }, 1500);
            }
  ...
  return function createNewMeeting(_x4) {
...
var signForMeetingButtons = document.querySelectorAll('.signForMeetingBtn');
var createMeetingForm = document.querySelector('.form-create-meeting');
var signUpForm = document.querySelector('.form--signUp');
signForMeetingButtons.forEach(function (signButton) {
  signButton.addEventListener('click', function (e) {
    e.preventDefault();
    console.log(signButton.value);
    (0, _updateSettings.signForMeeting)(signButton.value);
  });
}); // VALUES
// DELEGATION
...
if (createMeetingForm) {
  createMeetingForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(e) {
      var info, place, date, limit;
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 8;
              return (0, _updateSettings.createNewMeeting)({
                info: info,
                place: place,
                date: date,
                limit: limit
...
if (signUpForm) {
  signUpForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(e) {
      var name, email, role, faculty, password, passwordConfirm;
      return regeneratorRuntime.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
